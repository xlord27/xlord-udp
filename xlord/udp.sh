...
sleep 4
clear
echo " Cecking Tool UdpCustom By XlordTunneling......."
sleep 4
clear
...
sleep 4
clear
echo " Cecking Config Default By XlordTunneling......."
sleep 4
clear
...
[Unit]
Description=UDP Custom by XlordTunneling
